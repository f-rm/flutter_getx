...
import 'package:flutter_getx/top_view_controller.dart';
import 'zipcode_search_model.dart';
import 'package:get/get.dart';
import 'detail_view.dart';

void main() {
  runApp(const ZipCodeSearchApp());
}

final viewController = Get.put(TopViewController());

class ZipCodeSearchApp extends StatelessWidget {
  const ZipCodeSearchApp({super.key});
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Padding(
                ...
                child: _searchInputView(controller)),
            Obx(() {
              return _searchResultView(
                  viewController.zipCodeSearchModel.value?.results);
              ;
            })
          ],
        ),
...
Widget _searchInputView(TextEditingController controller) {
  return Row(children: <Widget>[
    ...
    ElevatedButton(
        ...
        onPressed: () {
          viewController.searchZipCode(controller.text);
        })
  ]);
}

Widget _searchResultView(List<ZipCodeSearchResult>? searchResults) {
